...
# 日本半導体関連銘柄 特設リスト（神宮の主力テーマ）
JP_SEMI_TICKERS = {
    # === 製造装置（前工程・露光・成膜・エッチング） ===
    "8035.T", "6857.T", "6920.T", "7735.T", "6146.T", "7729.T",
    "6525.T", "8036.T", "6590.T", "6324.T", "4369.T", "6856.T",
    "7745.T", "6135.T", "6196.T", "5208.T",
    # === 検査・計測 ===
    "6856.T", "6849.T", "7780.T",
    # === ウェハー・シリコン素材 ===
    "3436.T", "4063.T", "4901.T", "5333.T",
    # === レジスト・フォトレジスト ===
    "4185.T", "4186.T", "4203.T",
    # === 半導体材料（化学・ガス・薬品） ===
    "4188.T", "4004.T", "4042.T", "4202.T", "4023.T", "4205.T",
    "4061.T", "4045.T", "4368.T", "4109.T",
    # === 後工程・パッケージング ===
    "6890.T", "6967.T", "7912.T", "7911.T", "5803.T", "5333.T",
    # === メモリ・センサ・専門IC ===
    "285A.T", "6758.T", "6963.T", "6526.T", "6723.T", "6875.T",
    "6769.T", "6779.T", "6770.T", "6707.T", "4694.T",
    # === パワー半導体 ===
    "6504.T", "6503.T", "6502.T", "6976.T", "6981.T", "6586.T",
    "6594.T", "6951.T",
    # === コネクタ・受動部品 ===
    "6981.T", "6976.T", "6770.T", "6925.T", "6961.T", "6845.T",
    "6803.T", "6804.T",
    # === 半導体商社 ===
    "3132.T", "8154.T", "8140.T", "9744.T", "7240.T", "8060.T",
    "9697.T",
    # === 治具・周辺機器 ===
    "6995.T", "5973.T", "7711.T", "6817.T", "6885.T", "6986.T",
    "6473.T",
    # === EUV/レーザー・光学部品 ===
    "6962.T", "7741.T", "6849.T", "6149.T",
    # === 先端材料・量子・新素材 ===
    "6521.T", "5016.T", "4541.T", "4204.T", "4634.T",
    # === 設計・EDA・IPコア ===
    "6779.T", "3776.T", "3923.T",
    # === 関連大型・コングロマリット ===
    "6501.T", "6502.T", "6503.T", "6701.T", "6752.T", "6502.T",
    "6724.T", "6753.T",
}
...
WHITELIST_TICKERS = {
    ...
    "3993.T",   # PKSHA
    "4382.T",   # HEROZ
} | JP_SEMI_TICKERS  # 日本半導体銘柄は自動的にホワイトリスト
...
def assign_theme(row):
    """銘柄のテーマタグを判定。複数候補から最優先1つを返す。
    日本半導体特設リスト在籍銘柄は最優先で jp_semi タグ"""
    ticker = str(row.get("ticker", ""))
    if ticker in JP_SEMI_TICKERS:
        return "jp_semi"
    blob = " ".join([str(row.get("sector", "")), str(row.get("industry", "")),
...
def main():
    ...
    payload = {
        ...
        "themes": {
            ...
            for k in ["jp_semi", "geopol", "quantum", "space", "semi", "battery", "energy", "material", "other"]
        },
